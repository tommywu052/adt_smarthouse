    ...
    public class TextMeshReceiver : DataReceiver
    {
        ...
        override public void OnReceivedData(object sender, EventArgs args)
        {
            ...
            }  else if (pname == "cameraL1")
            {
                ...
                //else
                //    text = "Empty";
                if (myArgs.Text.Contains("label")){
                Debug.Log(myArgs.Text);    
                text = mySensors.label;
                if(text =="person   ")
                peoplecnt = peoplecnt +1 ;

                text = text +"\n Total:"+peoplecnt.ToString();
                
                needsUpdated = true;
                }
                
            }
            else if (pname == "cameraR1")
            {
